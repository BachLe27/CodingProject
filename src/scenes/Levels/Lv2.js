...
export class Lv2 extends Phaser.Scene {
   constructor() {
      super('Lv2');
   }
   ...
   create() {
      ...
      this.game.registry.set('totalChest', 6);

      this.game.registry.set('hasKey', false);
      this.game.registry.set('level', 2);
      ...
      this.createVirus();
      // Cau hoi
      this.data = this.shuffle(this.game.cache.json.entries.entries.questions2.questions);
